...
// TBD
const RESOURCE_FACETS: Facets = []

export default function SearchPage(): JSX.Element {
  const [results, setSearchResults] = useState([])
  const [facets, setSearchFacets] = useState<Facets>(null)
  ...
  const runSearch = useCallback(
    async (text: string, activeFacets: Facets, from: number): Promise<void> => {
