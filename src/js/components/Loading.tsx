...
export const AnimatedEmptyCard = () => <div className="post-content-loader">
    <Card className="compact-post-summary">
      <ContentLoader speed={contentLoaderSpeed} style={{
      width: "100%",
      height: "137px"
    }} width={1000} height={137} preserveAspectRatio="none">
...
export default function Loading() {
  return <div className="card-list-loader">
      {times(i => <AnimatedEmptyCard key={i} />, 10)}
    </div>;
}
